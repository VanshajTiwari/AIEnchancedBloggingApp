...
import image from "./../../public/loginImg.jpeg";
  ...
  return (
            ...
            <div className="bg-gray-100 flex justify-center items-center h-screen">
                <div className="w-7/12 h-screen hidden lg:block">
                    <Image src={image} alt="Placeholder Image" className="object-cover w-full h-full"/>
                </div>

                <div className="lg:p-36 md:p-52 sm:20 p-8 w-full lg:w-5/12">
