export default function RecommendedArticle(){
    return(            
      <article className="flex max-w-[330px] border rounded-sm border-gray-900 shadow">
        <div className="w-full flex justify-center items-center --article">
          ...
          <p className="w-3/5 text-[15px] text-gray-500 ml-2">Lorem ipsum dolor sit amet consectetur adipisicing elit. Delectus, quae?</p>
        </div>
      </article>
      )
}